...
private func makeRustCall<T, E: Swift.Error>(
    ...
    uniffiEnsureCelEvalInitialized()
...
fileprivate struct UniffiCallbackInterfaceHostContext {
    ...
    static let vtable: [UniffiVTableCallbackInterfaceHostContext] = [UniffiVTableCallbackInterfaceHostContext(
        computedProperty: { (
            uniffiHandle: UInt64,
            name: RustBuffer,
            args: RustBuffer,
            ...
            let makeCall = {
                ...
                return uniffiObj.computedProperty(
                     name: try FfiConverterString.lift(name),
                     args: try FfiConverterString.lift(args),
                     callback: try FfiConverterTypeResultCallback_lift(callback)
                )
            }
        ...
        deviceProperty: { (
            ...
            let makeCall = {
                ...
                return uniffiObj.deviceProperty(
                     name: try FfiConverterString.lift(name),
                     args: try FfiConverterString.lift(args),
                     callback: try FfiConverterTypeResultCallback_lift(callback)
                )
...
public struct FfiConverterTypeHostContext: FfiConverter {
    fileprivate static let handleMap = UniffiHandleMap<HostContext>()
...
public protocol ResultCallbackProtocol: AnyObject, Sendable {
    
    func onResult(result: String) 
    
}
open class ResultCallback: ResultCallbackProtocol, @unchecked Sendable {
    fileprivate let pointer: UnsafeMutableRawPointer!
...
#endif
    public func uniffiClonePointer() -> UnsafeMutableRawPointer {
        return try! rustCall { uniffi_cel_eval_fn_clone_resultcallback(self.pointer, $0) }
    }
    // No primary constructor declared for this class.
    ...
    deinit {
        ...
        try! rustCall { uniffi_cel_eval_fn_free_resultcallback(pointer, $0) }
    }

    

    
open func onResult(result: String)  {try! rustCall() {
    uniffi_cel_eval_fn_method_resultcallback_on_result(self.uniffiClonePointer(),
...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeResultCallback: FfiConverter {

    typealias FfiType = UnsafeMutableRawPointer
    typealias SwiftType = ResultCallback

    public static func lift(_ pointer: UnsafeMutableRawPointer) throws -> ResultCallback {
        return ResultCallback(unsafeFromRawPointer: pointer)
    }

    public static func lower(_ value: ResultCallback) -> UnsafeMutableRawPointer {
        return value.uniffiClonePointer()
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> ResultCallback {
        let v: UInt64 = try readInt(&buf)
        // The Rust code won't compile if a pointer won't fit in a UInt64.
        // We have to go via `UInt` because that's the thing that's the size of a pointer.
        let ptr = UnsafeMutableRawPointer(bitPattern: UInt(truncatingIfNeeded: v))
    ...
    public static func write(_ value: ResultCallback, into buf: inout [UInt8]) {
        // This fiddling is because `Int` is the thing that's the same size as a pointer.
        // The Rust code won't compile if a pointer won't fit in a `UInt64`.
        writeInt(&buf, UInt64(bitPattern: Int64(Int(bitPattern: lower(value)))))
    }
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeResultCallback_lift(_ pointer: UnsafeMutableRawPointer) throws -> ResultCallback {
    return try FfiConverterTypeResultCallback.lift(pointer)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeResultCallback_lower(_ value: ResultCallback) -> UnsafeMutableRawPointer {
    return FfiConverterTypeResultCallback.lower(value)
}
...
public func evaluateAstWithContext(definition: String, context: HostContext) -> String  {
    ...
    uniffi_cel_eval_fn_func_evaluate_ast_with_context(
        ...
        FfiConverterTypeHostContext_lower(context),$0
    )
})
}
...
public func uniffiEnsureCelEvalInitialized() {
